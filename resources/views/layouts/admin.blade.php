                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ route('admin.index') }}" id="site-logo-inner">
                            <img class="" id="logo_header_1" alt="logo_header" src="{{ asset('images/logo/logo.png') }}"
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <form action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <a href="{{ route('logout') }}" class="logout" onclick="event.preventDefault(); this.closest('form').submit(); return false;">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <form action="{{ route('logout') }}" method="POST">
                                                    @csrf
                                                    <a href="{{ route('logout') }}" class="user-item" onclick="event.preventDefault(); this.closest('form').submit(); return false;">
                                                        <div class="icon">
