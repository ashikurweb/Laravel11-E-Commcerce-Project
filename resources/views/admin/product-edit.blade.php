...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form method="POST" action="{{ route('admin.product-update') }}" class="tf-section-2 form-add-product" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="upload-image mb-16">
                                @if ( $product->images )
                                    @foreach ( explode(',', $product->images) as $img )
                                        <div class="item">
                                            <img src="{{ asset('uploads/products/' . $img) }}" alt="{{ $product->name }}">
                                        </div>
                                    @endforeach
                                @endif
